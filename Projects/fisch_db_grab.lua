-- Decompiled and located at ReplicatedStorage.modules.library.fish<Instance::ModuleScript>
---------------------------------------
local fish = {
...
local module_upvr = {
    ...
    Rarities = {"Trash", "Common", "Uncommon", "Unusual", "Rare", "Legendary", "Mythical", "Divine", "Limited", "Relic", "Exotic", "Fragment", "Gemstone"};
    RarityColours = {
...
local new = {}
for fish, data in next, fishData do
...
setclipboard(game:GetService("HttpService"):JSONEncode(new))
