...
assert(request and isfolder and makefolder, "Exploit not supported [ must have request, isfolder and makefolder")
...
if not Info.Timeout then
    ...
    Cache.add(notificationCloseButton.MouseButton1Click:Connect(function()
...
mainShadow.Image = "rbxassetid://13379768034"
...
Cache.add(topbar.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        dragging = true
        dragStart = input.Position
        startPos = main.Position

        Cache.add(input.Changed:Connect(function()
...
Cache.add(topbar.InputChanged:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
        dragInput = input
    end
end))

Cache.add(UserInputService.InputChanged:Connect(function(input)
...
Cache.add(closeButton.MouseEnter:Connect(function()
...
Cache.add(closeButton.MouseLeave:Connect(function()
...
Cache.add(closeButton.MouseButton1Click:Connect(function()
    unnamed:Destroy()
    shadow:Destroy()
...
Cache.add(minimizeButton.MouseEnter:Connect(function()
...
Cache.add(minimizeButton.MouseLeave:Connect(function()
...
Cache.add(minimizeButton.MouseButton1Click:Connect(function()
...
Cache.add(tabFrame.MouseEnter:Connect(function()
...
Cache.add(tabFrame.MouseLeave:Connect(function()
    if SelectedTab == nil or SelectedTab ~= tab then
...
sectionIcon.Image = "rbxassetid://13379768236"
...
Cache.add(itemContainer.ChildAdded:Connect(function(v)
...
Cache.add(sectionButton.MouseButton1Click:Connect(function()
    sectiontable:Select()
end))
...
Cache.add(keybindFrame.MouseEnter:Connect(function()
...
Cache.add(keybindFrame.MouseLeave:Connect(function()
...
Cache.add(keybindOuterText:GetPropertyChangedSignal("Text"):Connect(function()
...
Cache.add(keybindTextButton.MouseButton1Click:Connect(function()
...
dragIcon.Image = "rbxassetid://13379768141"
...
Cache.add(sliderFrame.MouseEnter:Connect(function()
...
Cache.add(sliderFrame.MouseLeave:Connect(function()
...
Cache.add(dragButton.MouseButton1Down:Connect(function()
...
Cache.add(dragButton.MouseButton1Up:Connect(function()
    TweenService:Create(sliderUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = Theme.ItemUIStroke}):Play()
end))
...
Cache.add(dragButton.MouseButton1Down:Connect(function() -- Skidded from material ui hehe, sorry
	local MouseMove, MouseKill
	MouseMove = Cache.add(Mouse.Move:Connect(function()
	...
	MouseKill = Cache.add(UserInputService.InputEnded:Connect(function(UserInput)
...
if (Info.NotClearOnFocus or Info.DontClearOnFocus or Info.DontClearTextOnFocus or Info.NotClearTextOnFocus) then
    pcall(function() textBox.ClearTextOnFocus = false end)
end

Cache.add(inputFrame.MouseEnter:Connect(function()
...
Cache.add(inputFrame.MouseLeave:Connect(function()
...
Cache.add(textBox.Focused:Connect(function()
...
Cache.add(textBox.FocusLost:Connect(function()
...
return {
  SetText = function(txt) textBox.Text = type(txt)=="string" and txt or "";if Info.Flag ~= nil then
		library.Flags[Info.Flag] = textBox.Text
	end end,
...
dropdownIcon.Image = "rbxassetid://13379768236"
...
Cache.add(dropdownFrame.MouseEnter:Connect(function()
...
Cache.add(dropdownFrame.MouseLeave:Connect(function()
...
Cache.add(dropdownTextButton.MouseButton1Down:Connect(function()
...
Cache.add(dropdownTextButton.MouseButton1Up:Connect(function()
    TweenService:Create(dropdownUIStroke, TweenInfo.new(.125, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = Theme.ItemUIStroke}):Play()
end))
...
Cache.add(dropdownElement.MouseEnter:Connect(function()
...
Cache.add(dropdownElement.MouseLeave:Connect(function()
...
Cache.add(dropdownElementButton.MouseButton1Click:Connect(function()
...
function insidedropdown:Remove(opt)
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" and v:FindFirstChild("dropdownElementText") and v:FindFirstChild("dropdownElementText").Text == opt then
            DropdownY = DropdownY - 24
            if DropdownOpened then
                TweenService:Create(section, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, section.Size.Y.Offset - 24)}):Play()
                TweenService:Create(sectionFrame, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.Out), {Size = UDim2.new(0, 175, 0, sectionFrame.Size.Y.Offset - 24)}):Play()
...
function insidedropdown:Get(opt)
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" and v:FindFirstChild("dropdownElementText") and v:FindFirstChild("dropdownElementText").Text == opt then
            return v
        end
...
function insidedropdown:GetAll(opt)
    local list = {}
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" and v:FindFirstChild("dropdownElementText") then
            list[#list+1] = v:FindFirstChild("dropdownElementText").Text
        end
    end
    return list
end
...
function insidedropdown:Clear()
    for _,v in pairs(dropdownContainer:GetChildren()) do
        if v.ClassName == "Frame" and v:FindFirstChild("dropdownElementText") then
            insidedropdown:Remove(v:FindFirstChild("dropdownElementText").Text)
        end
    end
end
...
Cache.add(SectionOpened:GetPropertyChangedSignal("Value"):Connect(function()
    DropdownOpened = false
...
Cache.add(dropdownTextButton.MouseButton1Click:Connect(function()
...
Cache.add(toggleFrame.MouseEnter:Connect(function()
...
Cache.add(toggleFrame.MouseLeave:Connect(function()
...
Cache.add(toggleTextButton.MouseButton1Down:Connect(function()
...
Cache.add(toggleTextButton.MouseButton1Up:Connect(function()
...
toggleInner.Image = "rbxassetid://13379768141"
...
Cache.add(toggleTextButton.MouseButton1Click:Connect(function()
    Enabled = not Enabled
...
Cache.add(buttonFrame.MouseEnter:Connect(function()
...
Cache.add(buttonFrame.MouseLeave:Connect(function()
...
Cache.add(buttonTextButton.MouseButton1Down:Connect(function()
...
Cache.add(buttonTextButton.MouseButton1Up:Connect(function()
    TweenService:Create(buttonUIStroke, TweenInfo.new(.1, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {Color = Theme.ItemUIStroke}):Play()
end))

Cache.add(buttonTextButton.MouseButton1Click:Connect(function()
    task.spawn(Info.Callback)
end))
end
...
Cache.add(tabButton.MouseButton1Click:Connect(function()
    tabtable:Select()
end))
